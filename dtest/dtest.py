    ...
    async def fetch(self):
        async with ClientSession() as session:
            async with session.post(url, data=json.dumps(payload), headers=headers) as response:
                ...
                imageurl = data["data"]["activeMilestones"][0]["availableQuests"][0]["iconUrl"].replace('destiny//common','destiny/common')
                ...
                em.set_thumbnail(url="https://cdn.thetrackernetwork.com/destiny//common/destiny2_content/icons/4de13648c3bf8741e773d8e7e8a0164b.png")
